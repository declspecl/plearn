...
function ScrollArea({
    ...
    return (
        <ScrollAreaPrimitive.Root className={cn("relative size-full min-h-0 overflow-hidden rounded-[inherit]", className)} {...props}>
            <ScrollAreaPrimitive.Viewport
                className={cn(
                    "transition-shadows focus-visible:ring-ring focus-visible:ring-offset-background h-full overflow-y-auto overscroll-contain rounded-[inherit] outline-none focus-visible:ring-2 focus-visible:ring-offset-1 data-has-overflow-x:overscroll-x-contain",
                    scrollFade &&
