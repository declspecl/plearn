...
function ComboboxItem({
    ...
    return (
        ...
        >
            ...
            <div className={cn(hideIndicator ? "col-span-full col-start-1" : "col-start-2", contentClassName)}>{children}</div>
        </ComboboxPrimitive.Item>
    );
}
...
function ComboboxListVirtualized({ className, ...props }: ComboboxPrimitive.List.Props) {
    return <ComboboxPrimitive.List className={cn("not-empty:px-1 not-empty:py-1", className)} data-slot="combobox-list" {...props} />;
}
