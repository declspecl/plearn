...
interface VietnamesePracticePageProps {
    readonly searchParams: Promise<{
        mode?: string;
    }>;
}

export default async function VietnamesePracticePage({ searchParams }: VietnamesePracticePageProps) {
    ...
    return (
        <div className="plearn-page">
            <header className="mb-7 max-w-3xl">
                <p className="plearn-eyebrow">Vietnamese · Practice</p>
                ...
                <p className="mt-2 text-sm leading-7 text-[color:var(--plearn-ink-3)]">
                    Run AI-graded production practice without moving the spaced repetition schedule.
                </p>
            </header>

            <ReviewSession initialPracticeMode={initialPracticeMode} mode="practice" />
        </div>
    );
}
