...
const schema = z.object({
    ...
    TRANSIT_ASSISTANT_MODEL: z.string().default("gpt-5.6-luna"),
    TRANSIT_ASSISTANT_REASONING_EFFORT: z.enum(["low", "medium", "high"]).default("medium"),
    TRANSIT_ASSISTANT_SEARCH_CONTEXT_SIZE: z.enum(["low", "medium", "high"]).default("high"),
    TRANSIT_ASSISTANT_TIMEOUT_MS: z.coerce.number().int().positive().default(120_000),
    TRANSIT_ASSISTANT_MAX_RETRIES: z.coerce.number().int().min(0).max(3).default(1),
    TRANSIT_ASSISTANT_MAX_RUNS_PER_HOUR: z.coerce.number().int().positive().default(20),
...
export function getAppConfig(): AppConfig {
    ...
    cachedAppConfig = schema.parse({
        ...
        TRANSIT_ASSISTANT_MODEL: process.env.TRANSIT_ASSISTANT_MODEL,
        TRANSIT_ASSISTANT_REASONING_EFFORT: process.env.TRANSIT_ASSISTANT_REASONING_EFFORT,
        TRANSIT_ASSISTANT_SEARCH_CONTEXT_SIZE: process.env.TRANSIT_ASSISTANT_SEARCH_CONTEXT_SIZE,
        TRANSIT_ASSISTANT_TIMEOUT_MS: process.env.TRANSIT_ASSISTANT_TIMEOUT_MS,
        TRANSIT_ASSISTANT_MAX_RETRIES: process.env.TRANSIT_ASSISTANT_MAX_RETRIES,
        TRANSIT_ASSISTANT_MAX_RUNS_PER_HOUR: process.env.TRANSIT_ASSISTANT_MAX_RUNS_PER_HOUR,
