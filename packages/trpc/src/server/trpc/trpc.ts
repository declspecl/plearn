...
import type { ReviewSessionService, PracticeService } from "@plearn/core/srs/service";
...
export interface Services {
    ...
    readonly reviewSessionService: ReviewSessionService;
    readonly practiceService: PracticeService;
}
